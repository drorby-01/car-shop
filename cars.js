...
(function () {
    const cars = generateCars(100, true)//return 100 cars array 
    DOM.listData = document.getElementById("data");//point to the list container
    DOM.cardsData = document.getElementById("data-cards");//point to the cards container
    DOM.tableData = document.getElementById("table-data");
    DOM.tableHead = document.getElementById("table-head");
    DOM.whatToDraw = "list"//give me feedback what the last container i draw on 
    ...
    const checkBoxIsSunRoof = document.getElementById("checkBoxIsSunRoof");
    console.log(checkBoxIsSunRoof)

    checkBoxIsSunRoof.addEventListener("change",(e)=>{
        const showSunRoof = headers[0].find((element)=> element.value === "isSunRoof")
    ...
    listViewButton.addEventListener("click", function () {
        DOM.whatToDraw = "list";//update the dom pointer container 
